...
#        self.scaleLinSpeed.configure(command=lambda v: pdrobot_support.cb_scaleLinSpeed(v))
        ...
        self.buttonSetWp1.configure(text='''Set X''')
        ...
        #self.Checkbutton1.configure(command=lambda: pdrobot_support.cb_toggle_wp_set(self.set1_locked, self.buttonSetWp1))
        ...
        #self.Checkbutton3.configure(command=lambda: pdrobot_support.cb_toggle_wp_set(self.set3_locked, self.buttonSetWp3))
        ...
        #self.Checkbutton4.configure(command=lambda: pdrobot_support.cb_toggle_wp_set(self.set4_locked, self.buttonSetWp4))
